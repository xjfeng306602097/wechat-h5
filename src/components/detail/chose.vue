<template lang="html">
  <section class="chose" v-if="view">
    <div style="display: flex">
      <span style="width: 20%;"><img src="../../assets/detail/images/juanhoujia.jpg" class="final-price" /></span>
      <span style="width: 15%;" class="font-red">¥{{view.final_price}}</span>
      <span class="font-grey">天猫价¥{{view.price}}</span>
    </div>
...
@import '../../assets/detail/style.css';
.chose {
    padding: 3vw;
